        ...
        <>
            ...
            <Switch>
                <Route path={`${match.path}/a`} render={
                    (props) => <DetailsA {...props} stageKey="Stage 1" />
                } />
                <Route path={`${match.path}/b`} render={
                    (props) => <DetailsB {...props} stageKey="Stage 2" />
                } />
                <Route path={`${match.path}/c`} render={
                    (props) => <DetailsA {...props} stageKey="Stage 3" />
                } />
                <Route
                    exact
                    path={match.path}
                ...
                />
                <Route
                    render={() => <h3>Please select of the existing options.</h3>}
                />
            </Switch>
